...
CREATE TABLE IF NOT EXISTS `T_REPOSITORY` (
  ...
  `ENABLE_PAC` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否开启pac',
  `PAC_PROJECT_ID` varchar(32) NULL DEFAULT '' COMMENT 'PAC开启的项目ID',
...
CREATE TABLE IF NOT EXISTS `T_REPOSITORY_CODE_GIT` (
  ...
  `ENABLE_MR_BLOCK` bit(1) NULL DEFAULT b'0' COMMENT '是否开启Mr锁定',
  PRIMARY KEY (`REPOSITORY_ID`)
...
CREATE TABLE IF NOT EXISTS `T_REPOSITORY_PIPELINE_TASK`  (
  `PROJECT_ID` varchar(64) NULL DEFAULT NULL COMMENT '蓝盾项目ID',
  `PIPELINE_ID` varchar(64) NOT NULL COMMENT '流水线ID',
